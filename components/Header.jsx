  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 whitespace-nowrap">
        ...
        <NavItem href="/speaking">Services</NavItem>
        <NavItem href="/uses">Contact US</NavItem>
        <NavItem href="/uses">Tesorería</NavItem>
        {/* <NavItem href="/directiva">Directiva</NavItem>
        <NavItem href="/uses">Documentos</NavItem>
        <NavItem href="/uses">Contactos</NavItem> */}
      </ul>
    </nav>
  )
}
